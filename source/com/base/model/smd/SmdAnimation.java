...
/**
 * Class that represents smd animation ($sequence), defines a skeletal
...
public class SmdAnimation
{
	...
	private static final Logger logger = Logger.getLogger(SmdAnimation.class.getName());
	...
	/**
	 * Method that recovers the SkeletonPositions, each array position
	 * represents a frame and Skeleton contains the bone poses.
	 * 
	 ...
	 * 
	 * @param name
	 *            : String with the animation name.
	 */
	...
	/**
	 * Method that stablish SkeletonPositions, contains bone poses for each
	 * animation frame.
	 * 
	 * @param skeletonPositions
	 *            : array with SmdSkeleton.
	 */
	 ...
	 * 
	 * @param blendAnimation
	 *            : boolean, true for blend animation false if not.
	 */

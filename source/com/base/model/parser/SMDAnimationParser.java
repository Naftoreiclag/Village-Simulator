...
/**
 * Class that parses .smd file that contains a sequence. Recovers position data
...
public class SMDAnimationParser extends SMDParser
{
	...
	private static final Logger logger = Logger.getLogger(SMDAnimationParser.class.getName());
	 ...
	 * 
	 * @param path
	 *            String with path of .smd animation file.
	 */
	...
	public SmdAnimation parse()
	{
		...
		{
			logger.log(Level.SEVERE, "Error parsing .smd animation file " + filePath + " : ", Ex);
		}
		return animation;
	}
	...
	private void getBones(String line)
	{
		...
		{
			logger.log(Level.SEVERE, "Error building bone from line : " + line + " : ", Ex);
		}
	}
	 ...
	 * 
	 * @param line
	 *            line that contains the SmdBonePosition.
	 */
